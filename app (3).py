...
def initialize_database(db):
    ...
    if db.movies.count_documents({}) == 0:
        ...
        users_data = [
            {
                "username": "usuario1",
                "password": "contraseña1",  # En una app real, esto debería estar encriptado
...
def main():
    ...
    if not st.session_state.logged_in:
        ...
        with col2:
            st.info("""
            ### Usuarios de prueba:
            - **Usuario 1**: usuario1 / contraseña1
            - **Usuario 2**: usuario2 / contraseña2
            - **Usuario 3**: usuario3 / contraseña3
            """)
